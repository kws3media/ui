...
export const versions = {
  [pkg.version] : "https://ui.kws3.media/", 
...
<div className="page-top-right-artifacts box">
  ...
  <div className="dropdown">
    <span className="artifact-item tags has-addons"><span className="tag">Version</span><span className="tag is-primary">{pkg.version}</span></span>
  ...
  <div className="artifact-item-block is-hidden-mobile">
    <div className="field has-addons">
      <span className="control"><input id="npm-command-copier" className="input is-small has-background-light is-family-monospace" readOnly value={cmd} /></span>

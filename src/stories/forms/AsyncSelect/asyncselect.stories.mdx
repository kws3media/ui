...
import SearchableSelectDecorator from "./AsyncSelect.svelte";
import { action } from "@storybook/addon-actions";
import playInteractions from "./asyncselect.play.js";
...
<Canvas>
  <Story name="AsyncSelect" args={args} play={playInteractions}>
    {(args) => ({
      Component: SearchableSelectDecorator,
      props: args,
    })}

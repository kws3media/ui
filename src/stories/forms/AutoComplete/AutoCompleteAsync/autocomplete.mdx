...
<Canvas>
  <Story of={AutocompleteStories.AutoCompleteAsync} />
</Canvas>
...
<div class="notification is-primary is-light">
  <div class="columns">
    <div class="column">
      ...
      <p>Note: Highlighted results can be turned off by setting <code>highlighted\_results</code> property to <code>false</code></p>
    </div>
...
<Source language="javascript" code={dedent`import { AutoComplete } from '@kws3/ui';`} />

#### Import the SCSS:

<Source language="javascript" code={dedent`@import '@kws3/ui/styles/AutoComplete.scss';`} />

...
export let args = {
  ...
  no_options_msg: "No options",
  placeholder: "Write some Marvel character names...",
  show_highlighted_options: true
};
...
<div class="notification is-primary is-light">
  <div class="columns">
    <div class="column">
      ...
      <p>Note: <code>option.highlighted</code> contains matches characters wrapped inside <code>span</code> along with text </p>
    </div>
    <div class="column">
...
<Source
  ...
  code={dedent`
      ...
      $kws-autocomplete-text-matches-color: $text !default;
      ...
      $kws-autocomplete-options-z-index: $modal-z + 1;
    `}
/>

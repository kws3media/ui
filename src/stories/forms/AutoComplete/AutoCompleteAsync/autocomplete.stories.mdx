...
<div class="notification is-primary is-light">
  <div class="columns">
    <div class="column">
      ...
      <p>Note: <code>option.label</code> contains matched characters wrapped inside <code>span</code> along with text </p>
      <p>Note: highlighted results can be turn off by setting <code>highlighted_results</code> property <code>false</code></p>
    </div>
    <div class="column">

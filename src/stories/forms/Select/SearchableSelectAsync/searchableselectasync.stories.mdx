...
<Meta
  title="Forms/Select/SearchableSelectAsync"
...
## Load options by searching in realtime.
`}
/>

<Canvas>
  <Story name="SearchableSelectAsync" args={args} play={playInteractions}>
    {(args) => ({
      Component: SearchableSelectDecorator,
      props: args,
    })}
...
<ArgsTable story="SearchableSelectAsync" />

...
<div class="notification is-primary is-light">
  <div class="columns">
    <div class="column">
      ...
      <p><code>array\_item\[search\_key]</code> is used for search-as-you-type, </p>
      <p>and <code>array\_item\[value\_key]</code> is returned as the value once an item is selected.</p>

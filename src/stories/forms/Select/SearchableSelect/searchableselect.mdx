...
import * as SearchableselectStories from './searchableselect.stories';
...
<Canvas>
  <Story of={SearchableselectStories.SearchableSelect} />
</Canvas>
...
<div class="notification is-primary is-light">
  <div class="columns">
    <div class="column">
      ...
      <p>
        Can send either an array of strings, or an array of objects.<br />Always
        ensure the shape of the array items are consistent.
      </p>

      <p>
        When an array of objects is sent, <br />
        <code>array\_item\[search\_key]</code> is used for search-as-you-type, <br />
        and <code>array\_item\[value\_key]</code> is returned as the value once an
        item is selected.
      </p>
...
<Source language="javascript" code={dedent`import { SearchableSelect } from '@kws3/ui';`} />

#### Import the SCSS:

<Source language="javascript" code={dedent`@import '@kws3/ui/styles/Select.scss';`} />

...
<div className="notification is-primary is-light">
  <div className="columns">
    <div className="column">
      <h3 className="sb-unstyled subtitle">
     ...
     <p className="sb-unstyled">See supported data formats in example story above.</p>
      <p className="sb-unstyled">Note: <code>option.label</code> contains matched characters wrapped inside <code>&lt;span class="h"&gt;</code> tags. </p>
      <p className="sb-unstyled">Note: Highlighted results can be turned off by setting <code>highlighted_results</code> property to <code>false</code></p>
    </div>
    <div className="column">
      <h3 className="sb-unstyled subtitle">Customising dropdown text items</h3>
      <p className="sb-unstyled">See documentation for default slot.</p>
      <h4 className="sb-unstyled subtitle">Example:</h4>
      <Source
        language="jsx"

...
<div className="notification is-warning sb-unstyled">
<p className="">Tooltip Action does not use event delegation. <br/>Therefore, it can affect performance if there are a large number of tooltips.<br/><br/>The recommended way is to use tooltips via event delegation, see: <a href="./?path=/docs/helpers-tooltips-1-overview--docs">Tooltip Overview</a></p>
</div>

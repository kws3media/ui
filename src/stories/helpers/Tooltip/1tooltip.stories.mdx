...
Tooltips can also be attached via the tooltip action, see: <a href="/docs/helpers-tooltips-3-tooltip-action--3-tooltip-action">Tooltip Action</a>
</div>


---

`options` is an object, and it mirrors all the options listed here: <a target="_blank" href="https://atomiks.github.io/tippyjs/v6/all-props/">https://atomiks.github.io/tippyjs/v6/all-props/</a>   

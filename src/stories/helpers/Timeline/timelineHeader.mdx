...
import * as TimelineHeaderStories from './timelineHeader.stories';

export let args={}

<Version />

<Meta of={TimelineHeaderStories} />
...
<Canvas>
  <Story of={TimelineHeaderStories.TimelineHeader} />
</Canvas>
...
<Source language="javascript" code={ dedent`import { TimelineHeader } from '@kws3/ui';`} />

...
import * as SnackbarsStories from './snackbars.stories';
...
<Canvas>
  <Story of={SnackbarsStories.Snackbars} />
</Canvas>
...
<div class="columns">
  ...
  <div class="column is-6">
    ...
    <div class="notification is-info is-light">
      All button clicks will close the Snackbar.<br />
...
<Source language="javascript" code={ dedent`@import 'path/to/node_modules/@kws3/ui/styles/FloatingUI.scss';`} />

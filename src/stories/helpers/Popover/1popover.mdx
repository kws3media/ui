...
import * as $1PopoverStories from './1popover.stories';
...
<Canvas>
  <Story of={$1PopoverStories.Popover} />
</Canvas>
...
<Source language="javascript" code={ dedent`import { Popover } from '@kws3/ui';`} />
...
<Source language="javascript" code={ dedent`@import '@kws3/ui/styles/Tooltip.scss';`} />

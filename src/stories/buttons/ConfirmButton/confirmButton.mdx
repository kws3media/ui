...
<Canvas>
  <Story of={ConfirmButtonStories.ConfirmButton} />
</Canvas>
...
<Source language="html" code={ dedent`<ConfirmButton text="Do It?" color="primary" size="small" icon_only="true" disabled="false" />`} />

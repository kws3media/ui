...
import MultipleFileUploadDecorator from './MultipleFileUpload.svelte';
...
<Meta
  ...
  component={MultipleFileUploadDecorator}
  args={args}
  argTypes={{
    color: {
      control: 'select'
...
# MultipleFileUpload
## Custom Multiple file upload control
`}/>
...
<ArgsTable story="MultipleFileUpload" />

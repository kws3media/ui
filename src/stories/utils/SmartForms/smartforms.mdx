...
import * as SmartformsStories from './smartforms.stories';

<Version />

<Meta of={SmartformsStories} />
...
<Story of={SmartformsStories.SmartFormExample} />
...
<Story of={SmartformsStories.CustomValidatorExample} />

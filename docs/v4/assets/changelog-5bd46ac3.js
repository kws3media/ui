import{j as e}from"./jsx-runtime-15806eb5.js";import{u as d}from"./index-0b532f45.js";import{ae as c}from"./index-3f41c45d.js";import{M as r}from"./version-fd7ab27b.js";import"./iframe-d03f20d9.js";import"../sb-preview/runtime.js";import"./_commonjsHelpers-de833af9.js";import"./index-65ec3394.js";import"./index-356e4a49.js";function s(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",strong:"strong",ul:"ul",...d(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{id:"459",children:"4.5.9"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Remove left border radius on search button in ",e.jsx(n.code,{children:"DataSearch"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"FileUpload"})," Fix file name not populated in ",e.jsx(n.code,{children:"getFile()"})]}),`
`,e.jsxs(n.li,{children:["Fix form comparator so that new or removed object keys trigger ",e.jsx(n.code,{children:"touched"})]}),`
`]}),`
`,e.jsx(n.h2,{id:"458",children:"4.5.8"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"MultiSelect"})," Stop overwriting options prop in async mode"]}),`
`]}),`
`,e.jsx(n.h2,{id:"457",children:"4.5.7"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Fix SCSS deprecation warnings"}),`
`]}),`
`,e.jsx(n.h2,{id:"456",children:"4.5.6"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Fix chart tooltip box shadow colors"}),`
`,e.jsx(n.li,{children:"Add docs for LLMs"}),`
`]}),`
`,e.jsx(n.h2,{id:"455",children:"4.5.5"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Fix type of ",e.jsx(n.code,{children:"ToggleButtons"})," value, it can be any type"]}),`
`,e.jsx(n.li,{children:"Fix Charts axis text colours to match theme"}),`
`,e.jsx(n.li,{children:"Fix Charts axis line colours to match theme"}),`
`,e.jsx(n.li,{children:"Fix Charts grid line colours to match theme"}),`
`,e.jsxs(n.li,{children:["Fix type of ",e.jsx(n.code,{children:"context"})," prop of Button components, it can be any type"]}),`
`]}),`
`,e.jsx(n.h2,{id:"454",children:"4.5.4"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Bugfix, add types to exports"}),`
`]}),`
`,e.jsx(n.h2,{id:"453",children:"4.5.3"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Bugfix, add styles to exports"}),`
`]}),`
`,e.jsx(n.h2,{id:"452",children:"4.5.2"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Fix hardcoded color in ",e.jsx(n.code,{children:"Radio"})," component"]}),`
`,e.jsxs(n.li,{children:["Remove legacy additional ",e.jsx(n.code,{children:"is-active"})," class from active buttons in ",e.jsx(n.code,{children:"ToggleButtons"})," component"]}),`
`,e.jsxs(n.li,{children:["Fix value type in ",e.jsx(n.code,{children:"SearchableSelect"})]}),`
`,e.jsxs(n.li,{children:["Make ",e.jsx(n.code,{children:"AutoComplete"}),", ",e.jsx(n.code,{children:"SearchableSelect"})," and ",e.jsx(n.code,{children:"MultiSelect"})," components work in SSR mode"]}),`
`,e.jsxs(n.li,{children:["Fix default colors and output radius for ",e.jsx(n.code,{children:"RangeSlider"})]}),`
`,e.jsxs(n.li,{children:["Fix default thumb and output radius for ",e.jsx(n.code,{children:"RangeSlider"})]}),`
`]}),`
`,e.jsx(n.h2,{id:"451",children:"4.5.1"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Fix ActionReturn type for ",e.jsx(n.code,{children:"popover"})," action"]}),`
`,e.jsx(n.li,{children:"Update popover arrow default colour to be border color"}),`
`,e.jsxs(n.li,{children:["Fix dark mode default text colour in ",e.jsx(n.code,{children:"Timepicker"})," component"]}),`
`,e.jsxs(n.li,{children:["Fix default border colours for active and checked rows in ",e.jsx(n.code,{children:"Grid"})," component"]}),`
`,e.jsxs(n.li,{children:["Allow border colours to be configured for checked and active rows in ",e.jsx(n.code,{children:"Grid"})," component"]}),`
`]}),`
`,e.jsxs(n.h1,{id:"450-breaking",children:["4.5.0 ",e.jsx("span",{className:"has-text-danger",children:"[BREAKING]"})]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"This version requires Bulma v1"}),`
`,e.jsx(n.li,{children:"Supports bulma dark mode"}),`
`,e.jsxs(n.li,{children:["All SCSS files are now modular, so you need to use ",e.jsx(n.code,{children:"@use"})," instead of ",e.jsx(n.code,{children:"@import"})]}),`
`,e.jsxs(n.li,{children:["All SCSS variable names have been updated. Now they do not start with ",e.jsx(n.code,{children:"$kws-"})," and are more generic. This is due to using modular SCSS"]}),`
`,e.jsx(n.li,{children:"All SCSS variables now have default Bulma css variables as default values, so most of the time an override will not be required, and it will just work according to the active theme"}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ToggleButtons"})," component now has it's own SCSS file that needs to be imported"]}),`
`,e.jsxs(n.li,{children:["Default ",e.jsx(n.code,{children:"inactive_class"})," has changed in ",e.jsx(n.code,{children:"ToggleButtons"})," component"]}),`
`,e.jsxs(n.li,{children:["Some internal class names in ",e.jsx(n.code,{children:"FileUpload"})," component have changed"]}),`
`,e.jsxs(n.li,{children:["Some internal class names in ",e.jsx(n.code,{children:"TimelineItem"})," component have changed"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Colorpicker"})," component's wrapper class name has changed"]}),`
`,e.jsxs(n.li,{children:["All instances of ",e.jsx(n.code,{children:"is-marginless"})," css class has been replaced with ",e.jsx(n.code,{children:"marginless"}),", as this is how new Bulma v1 supports it"]}),`
`,e.jsxs(n.li,{children:["All instances of ",e.jsx(n.code,{children:"is-paddingless"})," css class has been replaced with ",e.jsx(n.code,{children:"paddingless"}),", as this is how new Bulma v1 supports it"]}),`
`,e.jsxs(n.li,{children:["Fix ",e.jsx(n.code,{children:"datepicker"})," and ",e.jsx(n.code,{children:"timepicker"})," action return types"]}),`
`,e.jsxs(n.li,{children:["Fix utility ",e.jsx(n.code,{children:"cloneObject"})," type signature"]}),`
`,e.jsxs(n.li,{children:["Add ",e.jsx(n.code,{children:"transparent"})," to ",e.jsx(n.code,{children:"ExtendedColors"})," type"]}),`
`]}),`
`,e.jsx(n.h2,{id:"435",children:"4.3.5"}),`
`,e.jsxs(n.ul,{children:[`
...
`]})]})}function o(i={}){const{wrapper:n}={...d(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}function l(i){const n={h2:"h2",...d(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{}),`
`,e.jsx(c,{title:"Changelog",parameters:{previewTabs:{canvas:{hidden:!0}}}}),`
`,e.jsx(n.h2,{id:"changelog",children:"Changelog"}),`
`,e.jsx(o,{})]})}function g(i={}){const{wrapper:n}={...d(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(l,{...i})}):l(i)}export{g as default};

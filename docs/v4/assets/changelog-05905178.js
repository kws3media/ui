...
`,e.jsxs(n.li,{children:["All SCSS variable names have been updated. Now they do not start with ",e.jsx(n.code,{children:"$kws-"})," and are more genric. This is due to using modular SCSS"]}),`
`]}),`

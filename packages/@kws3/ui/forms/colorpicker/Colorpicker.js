export default (function (win, doc) {
  ...
  return (function ($) {
    ...
    (CP = function (target, events) {
      ...
      // initialize data ...
      set_data(
        CP.parse(target.getAttribute("data-color") || target.value || [0, 1, 1])
      );

      // generate color picker pane ...
      picker.className = "color-picker";
      picker.innerHTML =
        '<div class="color-picker-control"><span class="color-picker-h"><i></i></span><span class="color-picker-sv"><i></i></span></div>';
      var b = doc.body,

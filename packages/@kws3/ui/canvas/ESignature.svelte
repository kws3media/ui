<!--
  ...
  @param {string} [background_image=""] - Background image size for the canvas, Default: `""`
  ...
  @param {'start'|'center'|'end'} [control_position="center"] - Default position of controls, Default: `"center"`

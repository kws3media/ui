/** @typedef {typeof __propDef.props}  RadialChartProps */
/** @typedef {typeof __propDef.events}  RadialChartEvents */
/** @typedef {typeof __propDef.slots}  RadialChartSlots */
/**
 ...
 * - `brushScrolled`
 */
export default class RadialChart extends SvelteComponentTyped<{
    class?: string;
    width?: string;
    height?: string;
    data?: any[];
...
export type RadialChartProps = typeof __propDef.props;
export type RadialChartEvents = typeof __propDef.events;
export type RadialChartSlots = typeof __propDef.slots;
...
export {};
//# sourceMappingURL=RadialChart.svelte.d.ts.map